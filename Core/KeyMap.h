...
enum VirtKey : u32 {
	...
	// Simple stereo adjustment hotkeys.
	VIRTKEY_STEREO_DEPTH_DECREASE = 0x40000037,
	VIRTKEY_STEREO_DEPTH_INCREASE = 0x40000038,
	VIRTKEY_STEREO_CONVERGENCE_DECREASE = 0x40000039,
	VIRTKEY_STEREO_CONVERGENCE_INCREASE = 0x4000003A,
	VIRTKEY_STEREO_NEAR_PROTECTION_DECREASE = 0x4000003B,
	VIRTKEY_STEREO_NEAR_PROTECTION_INCREASE = 0x4000003C,
	VIRTKEY_STEREO_SWAP_EYES = 0x4000003F,
	VIRTKEY_LAST,
