...
static const ConfigSetting graphicsSettings[] = {
	...
	ConfigSetting("StereoRendering", SETTING(g_Config, bStereoRendering), true, CfgFlag::PER_GAME),
	ConfigSetting("StereoDepth", SETTING(g_Config, iStereoDepth), 50, CfgFlag::PER_GAME),
	ConfigSetting("StereoConvergence", SETTING(g_Config, iStereoConvergence), 20, CfgFlag::PER_GAME),
	ConfigSetting("StereoNearProtection", SETTING(g_Config, iStereoNearProtection), 40, CfgFlag::PER_GAME),
	ConfigSetting("StereoSwapEyes", SETTING(g_Config, bStereoSwapEyes), false, CfgFlag::PER_GAME),
	ConfigSetting("StereoToMonoShader", SETTING(g_Config, sStereoToMonoShader), "SideBySide", CfgFlag::PER_GAME),
